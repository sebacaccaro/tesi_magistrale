...
\begin{equation}
group: [t_1,...,t_n] \rightarrow [g1,...,g_q]
\end{equation}
...
\hl{Si puo espandere un po di piu?}
...
\end{equation}
\hl{Rivedere matematica, posso espandere?}
...
\centering
\begin{tabular}{ccccc}
\textbf{Codice} & \boldmath{$l_{min}$} & \boldmath{$l_{max}$} & \textbf{Lingue} & \textbf{Superpipeline}\\ \hline
\dsta & 8 & 50 & [it] & [T1, T2, T3, S1, S2, S3, M1, M2, M3]\\
\dstb & 20 & 100 & [it] & [T1, T2, T3, S1, S2, S3, M1, M2, M3]\\
\end{tabular}
