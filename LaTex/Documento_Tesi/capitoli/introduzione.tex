...
\item \textbf{\nameref{sec:dataset}}: in questo capitolo si discutono i motivi che hanno portato alla creazione di una dataset apposito, e si descrive la metodologia con la quale tale dataset è stato creato.
